            ...
            @foreach(session('cart') as $id => $details)
                ...
                <tr>
                    ...
                    <td class="actions" data-th="">
                        <button class="btn btn-info btn-sm update-cart" data-id="{{ $id }}"><i class="ion ion-android-refresh"></i></button>
                        <button class="btn btn-danger btn-sm remove-from-cart" data-id="{{ $id }}"><i class="ion ion-ios-trash"></i></button>
                    </td>
                </tr>
            @endforeach
        @endif
